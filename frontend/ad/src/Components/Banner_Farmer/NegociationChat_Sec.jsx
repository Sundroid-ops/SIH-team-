        ...
        <div className='flex flex-col justify-center'>
          <div className='text-center md:text-left space-y-4 lg:max-w-[400px]'>
            ...
            >
              ...
              Ensure mutual agreement on quality standards, payment schedules, and any
              additional terms. Ensure all details are agreed upon to secure a fair
              and transparent contract that benefits both parties.
            </motion.p>
            {/* button */}
            <motion.div
              variants={FadeUp(1.2)}
              ...
              <button
                // onClick={}                                 // onClick Function to go to the negotiation chat 
